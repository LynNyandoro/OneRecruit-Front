...
const LinkItems = [
  { name: 'Available Jobs', icon: MdWorkOutline, to: '/candidate/home' },
  { name: 'Applications', icon: MdOutlineMarkEmailRead, to: '/candidate/jobsApplied' },
];

export default function DashboardCandidate({ children }) {
